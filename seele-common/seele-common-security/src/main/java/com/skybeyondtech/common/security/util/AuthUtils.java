...
import com.skybeyondtech.common.security.auth.AuthLogic;
...
public final class AuthUtils {
     ...
     * @param token 指定token
     */
    public static void logoutByToken(final String token) {
     ...
     * @return 用户信息
     */
    public static LoginUser getLoginUser(final String token) {
     ...
     */
    public static void verifyLoginUserExpire(final LoginUser loginUser) {
     ...
     * @param role 角色标识
     */
    public static void checkRole(final String role) {
     ...
     */
    public static void checkRole(final RequiresRoles requiresRoles) {
     ...
     * @param roles 角色标识数组
     */
    public static void checkRoleAnd(final String... roles) {
     ...
     * @param roles 角色标识数组
     */
    public static void checkRoleOr(final String... roles) {
     ...
     * @param permission 权限码
     */
    public static void checkPermission(final String permission) {
